...
public class ProductController {
    ...
    // Modifies a products stock
    @PatchMapping("/{id}/stock")
    public ResponseEntity<ApiResponse<ProductEntity>> updateProduct(
            @PathVariable Integer id, @RequestBody UpdateStockRequest request) {
        ProductEntity updatedProduct = productService.updateStock(id, request);
        return ApiResponse.success(HttpStatus.OK, "Product updated successfully!", updatedProduct);
    }
